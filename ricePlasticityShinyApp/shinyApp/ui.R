  ...
  dashboardBody(
   ...
   tags$script(HTML('
    ...
    tabItems(
      ...
      fluidRow(splitLayout(cellWidths=c("1%", "43%", '1%', "15%"), '', textInput(inputId='search', label='Search:', value='', placeholder='Muliple IDs must only be separated by space or comma.', width='100%'), '', actionButton('search.but', 'Submit', align = "center", style = "margin-bottom: 2px;margin-top: 20px;"))),
