...
shinyUI(dashboardPage(
  ...
  dashboardSidebar(
    ...
    sidebarMenu(
      ...
      selectInput("fileIn", "Step1: data sets", 'none') # For STHM.
  ...
  dashboardBody(
   ...
   tags$script(src="javascript.js"),
    ...
    tabItems(
      ...
      box(title="Spatiotemporal Heatmap", status="primary", solidHeader=TRUE, collapsible=TRUE, htmlOutput("shm.ins"), width=12),
